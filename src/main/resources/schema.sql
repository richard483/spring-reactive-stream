...
CREATE TABLE roles (id SERIAL PRIMARY KEY, role TEXT NOT NULL);
CREATE TABLE users (id SERIAL PRIMARY KEY, name TEXT NOT NULL, role_id INT, CONSTRAINT role_id FOREIGN KEY (role_id) REFERENCES roles(id));
